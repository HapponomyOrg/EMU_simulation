...
def sumsy_supply_simulation():
    ...
    if parameter_form.validate_on_submit():
        ...
        simulation.inflation = parameter_form.inflation.data / 100
        ...
        if data_selection_form.money_mass.data:
            ...
            money_chart.add('Money mass',
                            get_data(simulation.money_mass, data_selection_form.money_mass_deflate.data,
        ...
        if data_selection_form.per_capita_money_mass.data:
            ...
            per_capita_money_chart.add('Money mass per capita',
                                       get_data(simulation.per_capita_money_mass,
        ...
        if data_selection_form.demurrage.data:
            ...
            demurrage_chart.add('Demurrage',
                                get_data(simulation.demurrage, data_selection_form.demurrage_deflate.data,
                                         simulation.inflation))
        ...
        if data_selection_form.per_capita_demurrage.data:
            ...
            per_capita_demurrage_chart.add('Demurrage per capita',
                                           get_data(simulation.per_capita_demurrage,
        ...
        if data_selection_form.new_money.data:
            ...
            new_money_chart.add('New money',
                                get_data(simulation.new_money, data_selection_form.new_money_deflate.data,
                                         simulation.inflation))
        ...
        if data_selection_form.per_capita_new_money.data:
            ...
            per_capita_new_money_chart.add('New money per capita',
                                           get_data(simulation.per_capita_new_money,
        ...
        if data_selection_form.common_good.data:
            ...
            common_good_chart.add('Spending', get_data(simulation.common_good_money,
        ...
        if data_selection_form.percentages.data:
            ...
            percentage_chart.add('Income', get_data(simulation.income_percentage))
            percentage_chart.add('Demurrage', get_data(simulation.demurrage_percentage))

            if parameter_form.common_good_spending.data != NONE:
                percentage_chart.add('Common good spending', get_data(simulation.common_good_percentage))

            percentage_chart.add('New money', get_data(simulation.new_money_percentage))
