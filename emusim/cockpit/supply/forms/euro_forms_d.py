...
class DataSelectionForm(FlaskForm):
    ...
    om = BooleanField('Bank reserve data', render_kw={'checked': True})
    im = BooleanField('RIM data', render_kw={'checked': True})
    bank = BooleanField('Bank data')
    private = BooleanField('Private sector data')
    assets = BooleanField('Financial assets data')
    qe = BooleanField('QE data', render_kw={'checked': True})

    income_expenses_percentage = BooleanField('Inflow & outflow')
    im_distribution = BooleanField('RIM distribution', render_kw={'checked': True})
    debt_percentage = BooleanField('Debt %', render_kw={'checked': True})
