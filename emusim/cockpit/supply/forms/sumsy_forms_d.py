...
class ParameterForm(FlaskForm):
    ...
    population = IntegerField('Initial population', default=1000000)
    population_growth = FloatField('Population growth rate', default=0.0)
    start_at_saturation = BooleanField('Start at saturation')
    money_mass = FloatField('Initial money mass', default=100000000)
...
class DataSelectionForm(FlaskForm):
    population = BooleanField('Population', render_kw={'checked': True})

    deflate = BooleanField('Deflate', render_kw={'checked': True})
    ...
    money_cycle = BooleanField('Money creation and destruction', render_kw={'checked': True})
    per_capita_money_cycle = BooleanField('Money creation and destruction per capita', render_kw={'checked': True})
    money_mass = BooleanField('Money mass', render_kw={'checked': True})
    per_capita_money_mass = BooleanField('Money mass per capita', render_kw={'checked': True})
    common_good = BooleanField('Common good spending')

    percentages = BooleanField('Percentages of total money mass', render_kw={'checked': True})
