...
overshoot_d = Blueprint('overshoot_d', __name__,
...
@overshoot_d.route('/overshoot_simulation_d', methods=['GET', 'POST'])
def overshoot_simulation_d():
    ...
    return render_template('overshoot_simulation_d.html',
                           date_form=date_form,
